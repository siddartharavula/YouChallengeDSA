  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        challengeResults.forEach(({ days, challenge }) => {
          updatedProgress[days].total = challenge.reduce((total, day) => {
            const dsaCount = day.problems?.length || 0;
            const sqlCount = day.sql?.length || 0;
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <div className="mb-5 sm:mb-6 rounded-2xl border border-gray-800 bg-gray-900 p-5 sm:p-6">
          ...
          <div className="mt-2 flex items-center gap-3">
            ...
            <span className="text-sm sm:text-base text-gray-500">days</span>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <p className="mt-3 text-2xl font-bold text-white">
                  <span className="text-green-500">{data.solved}</span>
                ...
                <div className="mt-3 flex items-center justify-between gap-2 text-xs text-gray-500">
                  ...
                  <span>{data.completedDays} days done</span>
                </div>
              </div>
            );
          })}
